...
mutate(Common_name = case_when(
    ...
    Common_name == "Kokanee"~ "Sockeye Salmon",
    TRUE~Common_name))%>%
...
D18<- D17 %>%
mutate(Sample_motivation = case_when(
  ...
  Study_name == "Dr Wetzel, Mote Marine Database" ~ "Background biomonitoring",
  Source_sampleID == "HOT M001"~ "Post-oil spill assessment",
  Source_sampleID == "HOT M002"~ "Post-oil spill assessment",
  Source_sampleID == "HOT M003"~ "Post-oil spill assessment",
  Source_sampleID == "HOTM004"~ "Post-oil spill assessment",
  Source_sampleID == "HOTM005"~ "Post-oil spill assessment",
  Source_sampleID == "HOTM006"~ "Post-oil spill assessment",
  Source_sampleID == "HOTM007"~ "Post-oil spill assessment",
  Source_sampleID == "HOTM008"~ "Post-oil spill assessment",
  Source_sampleID == "HOTM009"~ "Post-oil spill assessment",
  Source_sampleID == "HOTM010"~ "Post-oil spill assessment",
  Source_sampleID == "HOTM011"~ "Post-oil spill assessment",
  Source_sampleID == "HOTM012"~ "Post-oil spill assessment",
  Source_sampleID == "HOTM013"~ "Post-oil spill assessment",
  Source_sampleID == "HOTM014"~ "Post-oil spill assessment",
  Source_sampleID == "HOTM015"~ "Post-oil spill assessment",
  Source_sampleID == "HOTM016"~ "Post-oil spill assessment",
  Source_sampleID == "HOTM017"~ "Post-oil spill assessment",
  Source_sampleID == "HOTM018"~ "Post-oil spill assessment",
  Source_sampleID == "HOTM019"~ "Post-oil spill assessment",
  Source_sampleID == "HOTM020"~ "Post-oil spill assessment",
  Source_sampleID == "HOTM021"~ "Post-oil spill assessment",
  Source_sampleID == "HOTM022"~ "Post-oil spill assessment",  
  Source_sampleID == "HOTM023"~ "Post-oil spill assessment",
  Source_sampleID == "HOTM024"~ "Post-oil spill assessment",
  Source_sampleID == "HOTM025"~ "Post-oil spill assessment",
  Source_sampleID == "HOTM026"~ "Post-oil spill assessment",
  Source_sampleID == "HOTM027"~ "Post-oil spill assessment",
  Source_sampleID == "HOTM028"~ "Post-oil spill assessment",
  Source_sampleID == "HOTM029"~ "Post-oil spill assessment",
  Source_sampleID == "HOTM030"~ "Post-oil spill assessment",
  TRUE~Sample_motivation))%>%
mutate(Study_name_clean = case_when(  # Cleaning up study names in new column for better grouping and visusalizations
    ...
    Study_name ==  "Selendang" ~ "Seledang AYU Post Spill Monitoring",
...
D19<-D18%>%
mutate(Layman_group = case_when(
    Common_name == "Seaweed" ~ "Seaweed",
    Common_name == "Crab" ~ "Crabs/ Shrimp",
    Common_name == "Randolph's Scallop" ~ "Mussels",
    
    TRUE~Layman_group))%>%
mutate(Common_name = case_when(
  Common_name == "mussel" ~ "Mussel",
  TRUE~Common_name
))%>%
mutate(Species_standard = case_when(
  Species_standard == "pinnipeds" ~ "seal",
  TRUE~Species_standard))

write_xlsx(D19, "OSRI_Totals_Full.xlsx")
```
