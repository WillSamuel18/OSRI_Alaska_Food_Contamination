...
D9<-D8a%>%
  ...
  mutate(Value_standardized=Value)%>%
  mutate(
    Value_standardized = if_else(
      Study_name == "Dr Wetzel, Mote Marine Database",
      Value_standardized * 1000,
      Value_standardized
    ))%>%
  mutate(
    Value_standardized = if_else(
      Study_name == "Shigenaka 2008, Exxon Valdez Intertidal monitoring",
      Value_standardized * 1000,
      Value_standardized
    )
  )
